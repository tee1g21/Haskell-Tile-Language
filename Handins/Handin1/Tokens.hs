...
alex_action_3 = \p s -> TokenPlace p
alex_action_4 = \p s -> TokenNewLine p
alex_action_5 = \p s -> TokenRepeat p
alex_action_6 = \p s -> TokenFor p
alex_action_7 = \p s -> TokenIf p
alex_action_8 = \p s -> TokenElse p
alex_action_9 = \p s -> TokenRotate p
alex_action_10 = \p s -> TokenScale p
alex_action_11 = \p s -> TokenSize p
alex_action_12 = \p s -> TokenReflectX p
alex_action_13 = \p s -> TokenReflectY p
alex_action_14 = \p s -> TokenConjugate p
alex_action_15 = \p s -> TokenNegate p
alex_action_16 = \p s -> TokenSubtile p
alex_action_17 = \p s -> TokenFill p
alex_action_18 = \p s -> TokenBuild p
alex_action_19 = \p s -> TokenLeftCurly p
alex_action_20 = \p s -> TokenRightCurly p
alex_action_21 = \p s -> TokenLeftParen p
alex_action_22 = \p s -> TokenRightParen p
alex_action_23 = \p s -> TokenComma p
alex_action_24 = \p s -> TokenPlus p
alex_action_25 = \p s -> TokenMinus p
alex_action_26 = \p s -> TokenDivide p
alex_action_27 = \p s -> TokenMultiply p
alex_action_28 = \p s -> TokenMod p
alex_action_29 = \p s -> TokenEq p
alex_action_30 = \p s -> TokenLessThan p
alex_action_31 = \p s -> TokenGreaterThan p
alex_action_32 = \p s -> TokenSemiColon p
alex_action_33 = \p s -> TokenTilde p
alex_action_34 = \p s -> TokenTrue p
alex_action_35 = \p s -> TokenFalse p
alex_action_36 = \p s -> TokenAnd p
alex_action_37 = \p s -> TokenOr p
alex_action_38 = \p s -> TokenNot p
alex_action_39 = \p s -> TokenWhite p
alex_action_40 = \p s -> TokenBlack p
alex_action_41 = \p s -> TokenInt p (read s)
alex_action_42 = \p s -> TokenVar p s
